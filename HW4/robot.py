...
class Panda():
    ...
    # joint_values should be an array of length 9
    # by default it moves the robot to its home position
    def move_to_joint(self, joint_values=None, positionGain=1.0):
        targetPositions = [0.0, 0.0, 0.0, -2*np.pi/4, 0.0, np.pi/2, np.pi/4, 0.0, 0.0]
