...
#this took forever, so I just used one friend
# --------- Tests ---------
stat, p = ttest_rel(assisted_scores, unassisted_scores, alternative='greater')
print(f"Score p-value: {p:.4f}") #.9629

stat, p = ttest_rel(unassisted_time, assisted_time, alternative='less')
print(f"Time p-value: {p:.4f}") #.2544